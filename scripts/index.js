...
const popupCloseEditElement = document.querySelector(".popup__close-button_type_edit");
...
const popupCloseAddElement = document.querySelector(".popup__close-button_type_add");
